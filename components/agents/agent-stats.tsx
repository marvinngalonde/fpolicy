  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-success">R146,400</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">Sarah Jones</div>
          <p className="text-xs text-muted-foreground">R245,680 this month</p>
        </CardContent>
      </Card>
    </div>
  )
